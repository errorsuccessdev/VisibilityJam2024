...
WindowMessage msgArray[NUM_MSGS] =
{
    { 0, L"WM_NULL" },
    { 1, L"WM_CREATE" },
    { 2, L"WM_DESTROY" },
    ...
    { 265, L"WM_UNICHAR or WM_KEYLAST" },
    ...
    { 322, L"CB_SETEDITSEL" },
    { 323, L"CB_ADDSTRING" },
    { 324, L"CB_DELETESTRING" },
    { 325, L"CB_DIR" },
    { 326, L"CB_GETCOUNT" },
    { 327, L"CB_GETCURSEL" },
    { 328, L"CB_GETLBTEXT" },
    { 329, L"CB_GETLBTEXTLEN" },
    { 330, L"CB_INSERTSTRING" },
    { 331, L"CB_RESETCONTENT" },
    { 332, L"CB_FINDSTRING" },
    { 333, L"CB_SELECTSTRING" },
    { 334, L"CB_SETCURSEL" },
    { 335, L"CB_SHOWDROPDOWN" },
    { 336, L"CB_GETITEMDATA" },
    { 337, L"CB_SETITEMDATA" },
    { 338, L"CB_GETDROPPEDCONTROLRECT" },
    { 339, L"CB_SETITEMHEIGHT" },
    { 340, L"CB_GETITEMHEIGHT" },
    { 341, L"CB_SETEXTENDEDUI" },
    { 342, L"CB_GETEXTENDEDUI" },
    { 343, L"CB_GETDROPPEDSTATE" },
    { 344, L"CB_FINDSTRINGEXACT" },
    { 345, L"CB_SETLOCALE" },
    { 346, L"CB_GETLOCALE" },
    { 347, L"CB_GETTOPINDEX" },
    { 348, L"CB_SETTOPINDEX" },
    { 349, L"CB_GETHORIZONTALEXTENT" },
    { 350, L"CB_SETHORIZONTALEXTENT" },
    { 351, L"CB_GETDROPPEDWIDTH" },
    { 352, L"CB_SETDROPPEDWIDTH" },
    { 353, L"CB_INITSTORAGE" },
    { 355, L"CB_MULTIPLEADDSTRING" },
    { 356, L"CB_GETCOMBOBOXINFO" },
    { 357, L"CB_MSGMAX" },
    { 512, L"WM_MOUSEFIRST" },
    { 512, L"WM_MOUSEMOVE" },
    ...
    { 564, L"WM_MDIREFRESHMENU" },
    { 568, L"WM_POINTERDEVICECHANGE" },
    { 569, L"WM_POINTERDEVICEINRANGE" },
    { 570, L"WM_POINTERDEVICEOUTOFRANGE" },
    { 576, L"WM_TOUCH" },
    { 577, L"WM_NCPOINTERUPDATE" },
    { 578, L"WM_NCPOINTERDOWN" },
    { 579, L"WM_NCPOINTERUP" },
    { 581, L"WM_POINTERUPDATE" },
    { 582, L"WM_POINTERDOWN" },
    { 583, L"WM_POINTERUP" },
    { 585, L"WM_POINTERENTER" },
    { 586, L"WM_POINTERLEAVE" },
    { 587, L"WM_POINTERACTIVATE" },
    { 588, L"WM_POINTERCAPTURECHANGED" },
    { 589, L"WM_TOUCHHITTESTING" },
    { 590, L"WM_POINTERWHEEL" },
    { 591, L"WM_POINTERHWHEEL" },
    { 592, L"DM_POINTERHITTEST" },
    { 593, L"WM_POINTERROUTEDTO" },
    { 594, L"WM_POINTERROUTEDAWAY" },
    { 595, L"WM_POINTERROUTEDRELEASED" },
    { 640, L"WM_IME_REPORT" },
    ...
    { 656, L"WM_IMEKEYDOWN or WM_IME_KEYDOWN" },
    { 657, L"WM_IMEKEYUP or WM_IME_KEYUP" },
    { 672, L"WM_NCMOUSEHOVER" },
    { 673, L"WM_MOUSEHOVER" },
    { 674, L"WM_NCMOUSELEAVE" },
    { 689, L"WM_WTSSESSION_CHANGE" },
    { 704, L"WM_TABLET_FIRST" },
    { 735, L"WM_TABLET_LAST" },
    { 736, L"WM_DPICHANGED" },
    { 738, L"WM_DPICHANGED_BEFOREPARENT" },
    { 739, L"WM_DPICHANGED_AFTERPARENT" },
    { 740, L"WM_GETDPISCALEDSIZE" },
    { 675, L"WM_MOUSELEAVE" },
    { 768, L"WM_CUT" },
    { 769, L"WM_COPY" },
    { 770, L"WM_PASTE" },
    ...
    { 793, L"WM_APPCOMMAND" },
    { 794, L"WM_THEMECHANGED" },
    { 797, L"WM_CLIPBOARDUPDATE" },
    { 798, L"WM_DWMCOMPOSITIONCHANGED" },
    { 799, L"WM_DWMNCRENDERINGCHANGED" },
    { 800, L"WM_DWMCOLORIZATIONCOLORCHANGED" },
    { 801, L"WM_DWMWINDOWMAXIMIZEDCHANGE" },
    { 803, L"WM_DWMSENDICONICTHUMBNAIL" },
    { 806, L"WM_DWMSENDICONICLIVEPREVIEWBITMAP" },
    { 831, L"WM_GETTITLEBARINFOEX" },
    ...
    { 4300, L"LVM_GETEMPTYTEXT"  },
    { 4301, L"LVM_GETFOOTERRECT"  },
    { 4302, L"LVM_GETFOOTERINFO"  },
    { 4303, L"LVM_GETFOOTERITEMRECT"  },
    { 4304, L"LVM_GETFOOTERITEM"  },
    { 4305, L"LVM_GETITEMINDEXRECT"  },
    { 4306, L"LVM_SETITEMINDEXSTATE"  },
    { 4307, L"LVM_GETNEXTITEMINDEX"  },
    { 8192, L"CCM_FIRST"  },
    { 8192, L"OCM__BASE"  },
    { 8193, L"CCM_SETBKCOLOR"  },
    { 8194, L"CCM_SETCOLORSCHEME"  },
    { 8195, L"CCM_GETCOLORSCHEME"  },
    { 8196, L"CCM_GETDROPTARGET"  },
    { 8197, L"CCM_SETUNICODEFORMAT"  },
    { 8197, L"LVM_SETUNICODEFORMAT"  },
    { 8198, L"CCM_GETUNICODEFORMAT"  },
    { 8198, L"LVM_GETUNICODEFORMAT"  },
    { 8199, L"CCM_SETVERSION"  },
    { 8200, L"CCM_GETVERSION"  },
    { 8201, L"CCM_SETNOTIFYWINDOW"  },
    { 8203, L"CCM_SETWINDOWTHEME"  },
    { 8204, L"CCM_DPISCALE"  },
    { 8217, L"OCM_CTLCOLOR"  },
    { 8235, L"OCM_DRAWITEM"  },
...
WindowMessage getMessage(UINT msg)
{
    ...
    windowMessage.id = msg;

    if (msg < WM_USER)
    {
        int index = internalSearch(
            msg,
            0,
            NUM_MSGS
        );
        if (index > -1)
        {
            windowMessage = msgArray[index];
        }
        else
        {
            windowMessage.name =
                L"Window message not found";
        }
    }
    else if (msg < WM_APP)
    {
        windowMessage.name =
            L"Window class defined";
    }
    else if (msg < 0xc000)
    {
        windowMessage.name =
            L"Application defined";
    }
    else if (msg < 0xffff)
    {
        windowMessage.name =
            L"Dynamically registered";
    }
    else
    {
        windowMessage.name =
